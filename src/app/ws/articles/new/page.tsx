...
const OPTIONS: Option[] = [
  ...
  { label: "Education", value: "Education", disable: false },
  { label: "Santé", value: "Santé", disable: false },
  { label: "Ecologie", value: "Ecologie", disable: false },
  { label: "Citoyenneté", value: "Citoyenneté" },
  { label: "Culture", value: "Culture", disable: false },
  { label: "Femme", value: "Femme", disable: false },
  { label: "Divertissement", value: "Divertissement", disable: false },
  { label: "Voyages", value: "Voyages" },
  { label: "Cuisine", value: "Cuisine", disable: true },
  { label: "Art et design", value: "Art et design", disable: false },
];

const authors = [
  { label: "Mavoix.cd", value: "1" },
  { label: "Kahindo Lwanzo Alfred", value: "2" },
  { label: "Katembo Shukuru Victor", value: "3" },
  { label: "Tsongo Kamavu Karl", value: "4" },
  { label: "Kambere Sibamutaki Faden", value: "5" },
];
...
export default function WSNewArticlePage() {
